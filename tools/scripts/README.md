...
| `legacy_othello_rules.py` | deprecated | Transitional Python board replay helpers for old diagnostics. | Kept only while legacy wrappers still need local protocol tracking; do not use for new divergence extraction. |
