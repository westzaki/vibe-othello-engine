...
remain useful for provenance, dataset migration, and focused workflow
reproduction, but those scripts are no longer the canonical starting point.
...
| [`2026-06-01-pattern-teacher-v1.md`](2026-06-01-pattern-teacher-v1.md) | transitional trainer provenance | Deterministic split and rank-aware pattern iteration after `pattern_teacher_v0`. | Use the split/rank lessons only; start new training work from the canonical regularized pairwise trainer. |
| [`2026-06-01-phase-broad-v0.md`](2026-06-01-phase-broad-v0.md) | specialized transitional workflow | Phase-specific broad pattern-table workflow validation and negative candidate result. | Use workflow evidence for phase-aware table reproduction; do not use this trainer as the default for new experiments. |
...
- Transitional trainer reports may contain workflow lessons, but they are not
  the default starting point for new pattern experiments.
