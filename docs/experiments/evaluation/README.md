...
| [`2026-06-07-soft-exact-score-target-pattern-only.md`](2026-06-07-soft-exact-score-target-pattern-only.md) | experimental objective foundation | Soft exact-score target for PatternOnly exact-aware-listwise training, with 10K/50K runs, exact-overlap comparison, search smoke, and match negative evidence. | Use as the current clean PatternOnly objective foundation; do not promote the generated candidate or add retained eval tables. |
| [`2026-06-07-soft-exact-score-sign-anchor-pattern-only.md`](2026-06-07-soft-exact-score-sign-anchor-pattern-only.md) | experimental objective foundation | Small sign-anchor follow-up for the soft exact-score PatternOnly objective, with selected/expected 10K smoke, 50K run, exact-overlap gate, search smoke, and match negative evidence. | Use as sign-direction evidence for PatternOnly objective design; do not promote the generated candidate or add retained eval tables. |
